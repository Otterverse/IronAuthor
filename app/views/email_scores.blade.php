...
Thank you for participating in the 2017 Everfree Northwest Iron Author contest! This email contains your scores and any notes made by reviewing judges for your entry. But first, a quick reminder of the rules and judging methods.

We had 34 stories this year, and twelve reviewers for the initial phase of scoring. Reviewers were assigned stories randomly and anonymously. They then scored the story in five categories, on a scale of zero to five in each, and optionally left notes. Each story was scored by three different reviewers, and the scores were then averaged. The top stories were then reviewed and discussed by Titanium Dragon, Horizon, and myself (Xepher) as final judges, each of us ranking them in order of preference. Our winners were the top three in average ranking, with runners up (honorable mentions) for the remaining stories. Only after winners were selected did we reveal the names of the authors.
...
Theme: How well you implemented the given prompts/themes of this year's contest. The themes this year were: Telescope, Envoy, and Arena.

Misc: Pretty much "judges choice" and provides a place for extra credit if something stood out that wasn't covered by the other categories. For example, I bonused several stories for really great descriptions.


In summary, you can have anything from 0 to 5 in each category, with a total possible range between 0 and 25. Actual scores in this contest ranged from 8 to 22 (including many ties.)
...
One last note: The Iron Author website and public story list ( http://ironauthor.xepher.net ) will remain online until (at least) the end of August, but may be taken down after that. If you wish to read the stories of your fellow contestants, please do so before then.
